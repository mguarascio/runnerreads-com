...
class BookSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if not book:
            ...
            if product:
                book = Book(ASIN=validated_data['ASIN'], link=validated_data['link'], title=product.title, large_image=product.large_image_url, medium_image=product.medium_image_url, small_image=product.small_image_url, tiny_image=product.tiny_image_url, rank=9999)
                book.save()
